const products = [ 
    ...
    { 
        ...
        category: "Cap", name: "SST Plus Strap-Back Hat", 
        seller: "Addidas", 
    ...
    for(let product of products){
        ...
        <div class="card bg-base-100 w-96 shadow-xl">
            ...
            <div class="card-body items-center text-center">
              ...
              <p>${product.name}</p>
              <p>price: <span id="price">${product.details.price}</span></p>
              <div class="card-actions">
                <button onclick="addToCartProducts(${product.details.price})" class="btn btn-primary">Add to cart</button>
              </div>
            </div>
          </div>
        `;
...
function addToCartProducts(price){
    cartCount++;
    sumPrice+=price;
    const cartCounter = document.getElementById('cart');
    const cartTtl = document.getElementById('ttlItem');
    cartCounter.innerText = cartCount;
    cartTtl.innerText = cartCount;
     
    const ttlPrice = document.getElementById('subTotal');
    ttlPrice.innerText = sumPrice;
